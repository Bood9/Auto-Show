...
const Home = () => {
    ...
    return (
        <div className="min-h-screen bg-dark text-white overflow-x-hidden">
            {/* Hero Section */}
            <section className="relative min-h-screen flex items-start justify-center overflow-hidden pt-32 pb-12">
                ...
                <div className="relative z-20 text-center px-4 max-w-6xl mx-auto mt-0">
                    <motion.div
